...
async def cmd_start(update, context):
    ...
    texto = (
        "👋 <b>Bienvenidos a FASTMONEY Systems v2.1</b>\n\n"
        "Este bot es un terminal de inteligencia P2P avanzada. "
        "Capturamos 100+ anuncios por minuto para ofrecer analítica institucional.\n\n"
        "🚀 <b>Capacidades Clave:</b>\n"
        "• 🏦 <b>Multi-Exchange:</b> Binance, Bybit y OKX.\n"
        "• 🤖 <b>Merchant Intel:</b> Detección de bots y Automation Score.\n"
        "• 🧱 <b>Depth & Walls:</b> Localización de muros de liquidez.\n"
        "• 📊 <b>Spread Heatmaps:</b> Mapas de calor por día y semana.\n\n"
        "⚙️ Usa <code>/config</code> para configurar tu mercado (COP, VES).\n"
        "📖 Usa <code>/help</code> para explorar todos los comandos."
    )
...
async def cmd_help(update, context):
    ...
    texto = (
        ...
        "• <code>/volume</code>: Análisis de liquidez, rotación y dominancia de merchants.\n"
        "• <code>/depth</code>: Profundidad de mercado y slippage global.\n"
        "• <code>/depth muro</code>: Detecta muros de liquidez (soportes/resistencias).\n"
        "• <code>/depth bancolombia</code>: Profundidad filtrada por banco.\n\n"
        "📉 <b>COMANDOS DE SPREAD</b>\n"
        "• <code>/spread</code>: Media del Top 5 actual.\n"
        "• <code>/spread dia</code>: Mapa de calor de las últimas 24h.\n"
        "• <code>/spread semana</code>: Mapa de calor de los últimos 7 días.\n"
        "• <code>/spread banesco</code>: Spread filtrado por método de pago.\n"
        "• <code>/spread N-M</code>: Media en un rango de posiciones.\n"
        "• <code>/spread &gt;1.2</code>: <b>Análisis de Viabilidad</b> histórico.\n\n"
        "👤 <b>INTELECTO DE MERCHANT</b>\n"
        "• <code>/merchant @user</code>: Perfil con <b>Automation Score</b> e ID único.\n"
        "• <code>/merchant bots</code>: Ranking de posibles algoritmos detectados.\n"
